...
class Item(libs_models.BaseSoftDeleteDatesModel):
    ...
    sku = models.CharField(verbose_name='SKU', max_length=30, help_text='\'Stock Keeping Unit\' code of the item.')
    hsn = models.CharField(verbose_name='HSN', max_length=60, blank=True, help_text='\'Harmonized System of Nomenclature\' code of the item.')
    ...
    price = models.DecimalField(decimal_places=2, max_digits=12, help_text='Price of the item.')
    quantity = models.PositiveIntegerField(default=0, help_text='Current stock of the item.')
    tax_notes = models.CharField(verbose_name='Tax Notes', max_length=60, blank=True, help_text='Notes about the tax applied on the item.')
